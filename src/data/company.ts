export const COMPANY = {
  name: "Crystal Industries",
  shortName: "Crystal Industries",
  ...
  established: "2015",
  license: "APMC Registered • FSSAI Certified • Export Standard",
};

export const WHATSAPP_MESSAGE =
  "Hello Crystal Industries, I am interested in your spices and agro products. Please share current product specifications, images, and wholesale pricing.";
